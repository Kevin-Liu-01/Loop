export const clerkAppearance = {
  ...
  elements: {
    ...
    navbarButton: "text-[var(--color-ink-soft)] hover:bg-[var(--color-paper-2)] hover:text-[var(--color-ink)]",
    navbarButtonIcon: "text-[var(--color-ink-soft)]",
    pageScrollBox: "bg-[var(--color-paper)]",
    profileSection: "border-[var(--color-line)]",
    profileSectionTitle: "border-[var(--color-line)]",
    profileSectionTitleText: "text-[var(--color-ink)]",
    profileSectionPrimaryButton: "text-[#e8650a] hover:text-[#ff7a1a]",
    profileSectionContent: "text-[var(--color-ink)]",
    accordionTriggerButton: "text-[var(--color-ink)] hover:bg-[var(--color-paper-2)]",
    accordionContent: "bg-[var(--color-paper)]",
    activeDeviceIcon: "text-[var(--color-ink-soft)]",
    menuButton: "text-[var(--color-ink-soft)] hover:bg-[var(--color-paper-2)]",
    menuList: "bg-[var(--color-paper)] border-[var(--color-line)]",
    menuItem: "text-[var(--color-ink)] hover:bg-[var(--color-paper-2)]",
  },
};
