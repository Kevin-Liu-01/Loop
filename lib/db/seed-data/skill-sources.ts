...
const SRC = {
  ...
  openaiChangelog: src(
    ...
    ["openai", "api", "changelog"],
    {
      ...
      parser: "html-links",
      rationale:
        "Rank OpenAI changelog entries against the skill's query hints instead of trusting page order.",
      searchQueries: [
        "responses api",
        "agents sdk",
        "structured outputs",
  ...
  anthropicDocs: src(
    ...
    ["anthropic", "models", "api"],
    {
      ...
      parser: "sitemap",
      rationale:
        "Use the Anthropic docs sitemap to discover newly-added docs and rank them by relevance.",
  ...
  webDev: src("web-dev", "web.dev", "https://web.dev/feed.xml", "rss", [
    "web-platform",
    "performance",
    "pwa",
  ]),
  cssWg: src(
    "css-wg-drafts",
    "CSS Drafts",
    "https://github.com/w3c/csswg-drafts/releases.atom",
    "atom",
    ["css", "standards"]
  ),
  smashingMag: src(
  ...
  // --- SEO / GEO ---
  mozBlog: src("moz-blog", "Moz Blog", "https://moz.com/blog/feed", "rss", [
    "seo",
    "industry",
  ]),
  searchEngineLand: src(
    "search-engine-land",
    "Search Engine Land",
  ...
  githubAdvisory: src(
    ...
    ["security", "npm"],
    {
      ...
      parser: "html-links",
      rationale:
        "Treat the advisory index as a search surface and bias toward high-severity npm issues.",
      searchQueries: [
  ...
  snykBlog: src("snyk-blog", "Snyk Blog", "https://snyk.io/blog/feed/", "rss", [
    "security",
    "vulnerabilities",
  ]),
  owaspBlog: src("owasp-blog", "OWASP", "https://owasp.org/feed.xml", "rss", [
    "owasp",
    "appsec",
  ]),
  clerkChangelog: src(
  ...
  v8Blog: src("v8-blog", "V8 Blog", "https://v8.dev/blog.atom", "atom", [
    "v8",
    "javascript",
    "performance",
  ]),
