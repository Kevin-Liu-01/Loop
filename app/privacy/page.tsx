      ...
      <main className="mx-auto w-full max-w-[1100px] flex-1 px-6 pt-12 pb-20 max-md:px-5 max-md:pt-8">
        ...
        <article className="mt-10 max-w-[68ch]">
          ...
          <ul className={list}>
            ...
            <li>
              Technical data including browser type, device information, and IP
              address.
            </li>
            <li>
          ...
          <ul className={list}>
            ...
            <li>
              Send service-related communications (e.g. security alerts, billing
              updates).
            </li>
            <li>
          ...
          <p className={prose}>
            ...
            data, including encryption in transit (TLS) and at rest. However, no
          ...
          <p className={prose}>
            ...
            be communicated via email or an in-app notice. Continued use of Loop
