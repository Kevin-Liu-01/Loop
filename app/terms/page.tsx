...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: buildSiteUrl("/terms").toString(),
  },
  title: TITLE,
  twitter: {
      ...
      <PageShell inset className="flex min-h-0 flex-1 flex-col">
        ...
        >
          ...
          <article className="max-w-[68ch]">
            ...
            <p className={prose}>
              By accessing or using Loop, you agree to be bound by these Terms
            ...
            <p className={prose}>
              ...
              provide accurate information when creating an account and notify
            ...
            <p className={prose}>
              You retain ownership of content you create on Loop, including
              skills and automations. Loop retains all rights to the platform,
              its design, and underlying technology. You grant Loop a limited
              license to host and display your content as needed to operate the
              service.
            </p>
            ...
            <p className={prose}>
              Loop is provided &ldquo;as is&rdquo; and &ldquo;as
            ...
            <p className={prose}>
              To the maximum extent permitted by law, Loop and its operators
            ...
            <p className={prose}>
              ...
              changes will be communicated via email or in-app notice at least
              14 days before taking effect. Continued use constitutes
              acceptance.
            </p>
