...
export const buttonVariants: Record<ButtonVariant, string> = {
  ...
  soft: "border border-line bg-paper-2/80 text-ink-soft hover:border-accent/75 hover:bg-paper-3 hover:text-ink hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] dark:hover:bg-paper-2/55 dark:hover:shadow-[inset_0_0_0_1px_rgba(232,101,10,0.28)]",
};
